...
public class FSMItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FsmPackage.Literals.FSM__INTIAL_STATE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.FSM__STATE,
				 FsmFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.FSM__STATE,
				 FsmFactory.eINSTANCE.createSteadyState()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.FSM__STATE,
				 FsmFactory.eINSTANCE.createTransientState()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.FSM__INTIAL_STATE,
