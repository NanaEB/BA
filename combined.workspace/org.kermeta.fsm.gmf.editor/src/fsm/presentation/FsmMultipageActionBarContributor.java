...
import fsm.diagram.part.FsmDiagramActionBarContributor;
 ...
 */
public class FsmMultipageActionBarContributor extends
	...
	private IPropertyListener myEditorPropertyChangeListener = new IPropertyListener() {
		...
		public void propertyChanged(Object source, int propId) {
			if (myActiveEditorActionBars != null) {
				if (myActiveEditorActionBars.getContributor() instanceof FsmActionBarContributor) {
					((FsmActionBarContributor) myActiveEditorActionBars.getContributor()).update();
				}
			}
		}
	};
	...
	public void setActivePage(IEditorPart activeEditor) {
		if (activeEditor instanceof FsmDiagramEditor) {
	...
	public SubActionBarsExt getTreeSubActionBars() {
		if (myTreeSubActionBars == null) {
			myTreeSubActionBars = new SubActionBarsExt(getPage(),
					myActionBars2, new FsmActionBarContributor(),
					"org.example.emfgmf.Fsm.presentation.TreeActionContributor");
		}
	...
	public SubActionBarsExt getDiagramSubActionBars() {
		if (myDiagramSubActionBars == null) {
			myDiagramSubActionBars = new SubActionBarsExt(getPage(),
					myActionBars2,
					new FsmDiagramActionBarContributor(),
					"org.example.emfgmf.Fsm.presentation.DiagramActionContributor");
		}
