 ...
 *
 */
public abstract class FsmEditorPart extends EditorPart implements IMenuListener, IEditingDomainProvider {

	/**
	 * The "parent" editor that this editor part is embedded into. 
	 */
	protected FsmEditor parentEditor;
	
	/**
	 * Default constructor.  
	 * @param parent
	 */
	public FsmEditorPart(FsmEditor parent) {
		super();
	...
	public void menuAboutToShow(IMenuManager manager) {
	    ...
	    ((FsmActionBarContributor) ((FsmMultipageActionBarContributor) parentEditor
