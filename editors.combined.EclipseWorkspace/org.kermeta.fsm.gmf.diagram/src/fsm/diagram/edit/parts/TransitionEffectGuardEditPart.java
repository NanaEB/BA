 ...
 * @generated
 */
public class TransitionEffectGuardEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				FsmVisualIDRegistry
						.getType(fsm.diagram.edit.parts.TransitionEffectGuardEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TransitionEffectGuardEditPart(View view) {
		super(view);
	}
