...
public interface FsmPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int INITIAL_STATE__NAME = SUPER_STATE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int INITIAL_STATE_FEATURE_COUNT = SUPER_STATE_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the attribute '{@link fsm.InitialState#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see fsm.InitialState#getName()
	 * @see #getInitialState()
	 * @generated
	 */
