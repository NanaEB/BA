...
/**
 * This is the item provider adapter for a {@link fsm.InitialState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InitialStateItemProvider extends SuperStateItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InitialState_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InitialState_name_feature", "_UI_InitialState_type"),
				 FsmPackage.Literals.INITIAL_STATE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InitialState.class)) {
			case FsmPackage.INITIAL_STATE__NAME:
