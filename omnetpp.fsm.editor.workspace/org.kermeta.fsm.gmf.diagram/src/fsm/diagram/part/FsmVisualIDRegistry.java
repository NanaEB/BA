...
public class FsmVisualIDRegistry {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case ActionEditPart.VISUAL_ID:
			if (ActionEntryLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case EActionEditPart.VISUAL_ID:
			if (EActionExitLabelEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case Action2EditPart.VISUAL_ID:
			if (ActionEntryLabel2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case EAction2EditPart.VISUAL_ID:
			if (EActionExitLabel2EditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case SteadyStateSteady_entry_exit_actionsEditPart.VISUAL_ID:
		...
		case TransitionEditPart.VISUAL_ID:
			if (TransitionEffectGuardEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		}
