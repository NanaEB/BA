...
import fsm.diagram.edit.policies.TransitionItemSemanticEditPolicy;
...
public class TransitionEditPart extends ConnectionNodeEditPart implements
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransitionEffectGuardEditPart) {
			((TransitionEffectGuardEditPart) childEditPart)
