...
import fsm.diagram.edit.commands.TransitionCreateCommand;
 ...
 * @generated
 */
public class TransientStateItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (FsmVisualIDRegistry.getVisualID(incomingLink) == TransitionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (FsmVisualIDRegistry.getVisualID(outgoingLink) == TransitionEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (FsmElementTypes.Transition_4001 == req.getElementType()) {
