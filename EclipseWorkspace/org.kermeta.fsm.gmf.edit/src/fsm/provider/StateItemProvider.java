 ...
 * @generated
 */
public class StateItemProvider extends SuperStateItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FsmPackage.Literals.STATE__ENTRY);
			childrenFeatures.add(FsmPackage.Literals.STATE__EXIT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.STATE__ENTRY,
				 FsmFactory.eINSTANCE.createAction()));

		newChildDescriptors.add
			(createChildParameter
				(FsmPackage.Literals.STATE__EXIT,
				 FsmFactory.eINSTANCE.createeAction()));
	}
