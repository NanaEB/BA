 ...
 * @generated
 */
public class TransientStateNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TransientStateNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							...
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.TransientStateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
