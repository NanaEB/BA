 ...
 * @generated
 */
public class TransitionActionGuardEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				FsmVisualIDRegistry
						.getType(fsm.diagram.edit.parts.TransitionActionGuardEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TransitionActionGuardEditPart(View view) {
		super(view);
	}
