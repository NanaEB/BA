...
import fsm.diagram.edit.policies.ActionItemSemanticEditPolicy;
...
public class ActionEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActionEntryLabelEditPart) {
			((ActionEntryLabelEditPart) childEditPart)
