 ...
 * @generated
 */
public class EActionExitLabel2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EActionExitLabel2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							...
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.EActionExitLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
