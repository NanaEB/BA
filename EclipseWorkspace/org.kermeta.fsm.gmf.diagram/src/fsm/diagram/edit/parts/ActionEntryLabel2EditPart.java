 ...
 * @generated
 */
public class ActionEntryLabel2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActionEntryLabel2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							...
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.ActionEntryLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
