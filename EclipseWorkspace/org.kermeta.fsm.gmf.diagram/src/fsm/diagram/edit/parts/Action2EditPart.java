...
import fsm.diagram.edit.policies.Action2ItemSemanticEditPolicy;
...
public class Action2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ActionEntryLabel2EditPart) {
			((ActionEntryLabel2EditPart) childEditPart)
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 225, 255, 255);
