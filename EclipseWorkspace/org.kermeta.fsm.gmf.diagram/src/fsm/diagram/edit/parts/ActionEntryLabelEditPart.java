 ...
 * @generated
 */
public class ActionEntryLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActionEntryLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							FsmElementTypes.Action_3001,
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.ActionEntryLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
