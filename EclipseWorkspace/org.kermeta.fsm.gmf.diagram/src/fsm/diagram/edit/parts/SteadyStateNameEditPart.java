 ...
 * @generated
 */
public class SteadyStateNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SteadyStateNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							...
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.SteadyStateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
