...
import fsm.diagram.edit.policies.FsmTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InitialStateNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InitialStateNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new FsmTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							FsmElementTypes.InitialState_2002,
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.InitialStateNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					FsmEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
