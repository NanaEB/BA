 ...
 * @generated
 */
public class TransitionOutputEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				FsmVisualIDRegistry
						.getType(fsm.diagram.edit.parts.TransitionOutputEditPart.VISUAL_ID),
				new Point(0, 60));
	}
	 ...
	 * @generated
	 */
	public TransitionOutputEditPart(View view) {
		super(view);
	}
