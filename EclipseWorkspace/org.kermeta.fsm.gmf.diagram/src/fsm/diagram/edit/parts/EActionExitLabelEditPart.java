 ...
 * @generated
 */
public class EActionExitLabelEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EActionExitLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = FsmParserProvider
					.getParser(
							FsmElementTypes.EAction_3003,
							getParserElement(),
							FsmVisualIDRegistry
									.getType(fsm.diagram.edit.parts.EActionExitLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
