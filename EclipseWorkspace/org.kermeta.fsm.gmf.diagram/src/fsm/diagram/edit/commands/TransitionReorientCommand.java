...
public class TransitionReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof SuperState && newEnd instanceof SuperState)) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected SuperState getOldSource() {
		return (SuperState) oldEnd;
	}

	/**
	 * @generated
	 */
	protected SuperState getNewSource() {
		return (SuperState) newEnd;
	}
