 ...
 * @generated
 */
public class FsmViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return FSMEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& FsmVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = FsmVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = FsmVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!FsmElementTypes.isKnownElementType(elementType)
				...
				if (!FSMEditPart.MODEL_ID.equals(FsmVisualIDRegistry
		...
		return SteadyStateEditPart.VISUAL_ID == visualID
				|| TransientStateEditPart.VISUAL_ID == visualID
				|| InitialStateEditPart.VISUAL_ID == visualID
				|| ActionEditPart.VISUAL_ID == visualID
				|| EActionEditPart.VISUAL_ID == visualID
				|| Action2EditPart.VISUAL_ID == visualID
				|| EAction2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = FsmVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != FsmVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(FSMEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = FsmVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = FsmVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case SteadyStateEditPart.VISUAL_ID:
			return createSteadyState_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case TransientStateEditPart.VISUAL_ID:
			return createTransientState_2006(domainElement, containerView,
					index, persisted, preferencesHint);
		case InitialStateEditPart.VISUAL_ID:
			return createInitialState_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case ActionEditPart.VISUAL_ID:
			return createAction_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case EActionEditPart.VISUAL_ID:
			return createEAction_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case Action2EditPart.VISUAL_ID:
			return createAction_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		case EAction2EditPart.VISUAL_ID:
			return createEAction_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (FsmVisualIDRegistry.getVisualID(elementTypeHint)) {
	 ...
	 * @generated
	 */
	public Node createSteadyState_2005(EObject domainElement,
		...
		node.setType(FsmVisualIDRegistry.getType(SteadyStateEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createTransientState_2006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		node.setType(FsmVisualIDRegistry
				.getType(TransientStateEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createInitialState_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	public Node createAction_3001(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FsmVisualIDRegistry.getType(ActionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5006 = createLabel(node,
				FsmVisualIDRegistry.getType(ActionEntryLabelEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEAction_3003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FsmVisualIDRegistry.getType(EActionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
		...
		Node label5008 = createLabel(node,
				FsmVisualIDRegistry.getType(EActionExitLabelEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createAction_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FsmVisualIDRegistry.getType(Action2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createEAction_3004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(FsmVisualIDRegistry.getType(EAction2EditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	...
	public Edge createTransition_4001(EObject domainElement,
		...
		edge.setType(FsmVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!FSMEditPart.MODEL_ID.equals(FsmVisualIDRegistry
			...
			shortcutAnnotation.getDetails()
					.put("modelID", FSMEditPart.MODEL_ID); //$NON-NLS-1$
