 ...
 * @generated
 */
public class FsmNavigatorContentProvider implements ICommonContentProvider {
	...
	public FsmNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			Resource resource = myEditingDomain.getResourceSet().getResource(
					fileURI, true);
			ArrayList<FsmNavigatorItem> result = new ArrayList<FsmNavigatorItem>();
			...
			result.addAll(createNavigatorItems(
					selectViewsByType(topViews, FSMEditPart.MODEL_ID), file,
					false));
			return result.toArray();
		}

		if (parentElement instanceof FsmNavigatorGroup) {
			FsmNavigatorGroup group = (FsmNavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof FsmNavigatorItem) {
			FsmNavigatorItem navigatorItem = (FsmNavigatorItem) parentElement;
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case FSMEditPart.VISUAL_ID: {
			...
			FsmNavigatorGroup links = new FsmNavigatorGroup(
					Messages.NavigatorGroupName_FSM_1000_links,
					"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FsmVisualIDRegistry.getType(SteadyStateEditPart.VISUAL_ID));
			...
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FsmVisualIDRegistry.getType(InitialStateEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					FsmVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case SteadyStateEditPart.VISUAL_ID: {
			...
			FsmNavigatorGroup incominglinks = new FsmNavigatorGroup(
					Messages.NavigatorGroupName_SteadyState_2005_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			FsmNavigatorGroup outgoinglinks = new FsmNavigatorGroup(
					Messages.NavigatorGroupName_SteadyState_2005_outgoinglinks,
		...
		case TransientStateEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			FsmNavigatorGroup incominglinks = new FsmNavigatorGroup(
					Messages.NavigatorGroupName_TransientState_2006_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			FsmNavigatorGroup outgoinglinks = new FsmNavigatorGroup(
					Messages.NavigatorGroupName_TransientState_2006_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(
					Collections.singleton(sv),
		...
		case InitialStateEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			FsmNavigatorGroup outgoinglinks = new FsmNavigatorGroup(
					Messages.NavigatorGroupName_InitialState_2007_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getOutgoingLinksByType(Collections.singleton(sv),
					FsmVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case TransitionEditPart.VISUAL_ID: {
			LinkedList<FsmAbstractNavigatorItem> result = new LinkedList<FsmAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			FsmNavigatorGroup target = new FsmNavigatorGroup(
					Messages.NavigatorGroupName_Transition_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			FsmNavigatorGroup source = new FsmNavigatorGroup(
	 ...
	 * @generated
	 */
	private Collection<FsmNavigatorItem> createNavigatorItems(
			Collection<View> views, Object parent, boolean isLeafs) {
		ArrayList<FsmNavigatorItem> result = new ArrayList<FsmNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new FsmNavigatorItem(nextView, parent, isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof FsmAbstractNavigatorItem) {
			FsmAbstractNavigatorItem abstractNavigatorItem = (FsmAbstractNavigatorItem) element;
