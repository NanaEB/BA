...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	...
	public void initializePackageContents() {
		...
		getFSM_IntialState().getEKeys().add(this.getInitialState_Name());
		...
		getTransition_Target().getEKeys().add(this.getState_Name());
		...
		getSuperState_OutTrans().getEKeys().add(this.getTransition_Guard());
		getSuperState_OutTrans().getEKeys().add(this.getTransition_Effect());
